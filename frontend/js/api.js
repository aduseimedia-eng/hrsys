...
function buildSidebar(activePage, options = {}) {
  ...
  const workspaceNavItems = [
    ...
    { page: 'recruitment-requisitions', icon: briefcaseIcon(), label: 'Job requisitions', roles: ['admin', 'manager'], activeFor: ['recruitment', 'hiring', 'recruitment-form', 'recruitment-request-form'] },
