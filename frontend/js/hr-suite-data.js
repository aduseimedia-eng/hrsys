(function () {
  ...
  window.hrSuiteData = {
    modules: [
      { page: 'recruitment', title: 'Recruitment', eyebrow: 'Talent acquisition', metric: 'No roles yet', status: 'Create a requisition to begin', summary: 'Manage job requisitions, postings, candidates, offers, and the handoff to onboarding.', health: 0 },
