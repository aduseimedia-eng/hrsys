...
exports.create = async (req, res) => {
  try {
    ...
    await Promise.all(officers.filter(o => o.id !== req.user.id).map(o => notifyEmployee({ companyId:req.user.company_id, employeeId:o.id, type:'employee_query', message:`New employee query: ${subject}`, link:'/pages/queries.html' })));
