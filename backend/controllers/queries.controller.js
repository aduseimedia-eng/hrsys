...
exports.create = async (req, res) => {
  try {
    ...
    if (recipientId) { await notifyEmployee({companyId:req.user.company_id,employeeId:recipientId,type:'employee_query',message:`HR has sent you a query: ${subject}`,link:'/pages/performance.html#queries'});return res.status(201).json(rows[0]); }
